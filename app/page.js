    ...
    <div className="w-full px-4 sm:px-6 lg:px-8">
      <div className="max-w-[1200px] mx-auto">
        <div className="home-main py-12 justify-between gap-8">
          ...
          <div
            id="about"
            className="mt-8 shadow-[0px_36px_105px_0px_rgba(0.16862745583057404,0.21960780024528503,0.2980392277240753,0.10)] rounded-2xl p-10 flex flex-col md:flex-row gap-[30px] justify-center md:items-start relative bg-white">
              ...
              <div className="flex flex-col gap-1 relative">
                ...
                <div className="flex flex-col gap-4 items-start relative md:flex-row">
                  ...
                  <button className="rounded border border-[#a53dff] px-6 py-3 flex gap-3 justify-center items-center relative bg-white">
                    ...
                    <Link
                      href={
                        "https://drive.google.com/file/d/1abarlT5qygwgaeLy-G9gu2-3aolLyyQh/view?usp=sharing"
                      }
